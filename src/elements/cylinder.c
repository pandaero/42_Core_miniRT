...
/*   Updated: 2023/03/13 18:34:11 by pandalaf         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//Function creates a new cylinder element from another.
t_cylinder	cylinder_copy(t_cylinder other)
{
	t_cylinder	new;
	...
	new.orientation = direction_copy(other.orientation);
	new.top_cap = disc_copy(other.top_cap);
	new.base_cap = disc_copy(other.base_cap);
	return (new);
}
